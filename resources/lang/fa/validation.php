...
return [
    ...
    'attributes'             => [
        ...
        'forgot_field_input'    => 'کدملی یا ایمیل',
        'newPassword'           => 'رمزعبور جدید',
        'conformNewPassword'    => 'تکرار رمزعبور جدید',
        'verify_code_forgot_password' => 'کد تایید ایمیل شده',
        'full_name' => 'نام و نام خانوادگی',
        'father_name' => 'نام پدر(فارسی)',
        'birth_certificate_number' => 'شماره شناسنامه',
        'card_number' => 'شماره کارت',
        'image_educational_qualification' => 'تصویر مدرک تحصیلی',
        'shaba_number' => 'شماره شبا',
        'face_image' => 'تصویر چهره',
        'image_national_card' => 'تصویر کارت ملی',
        'birth_certificate' => 'تصویر شناسنامه',
        'image_promissory_note' => 'تصویر سفته',
        'current_password' => 'رمزعبور فعلی',
        'new_password' => 'رمزعبور جدید',
        'confirm_password' => 'تکرار رمزعبور',
        'insurance_policies_number' => 'شماره بیمه نامه',
        'date_of_issue' => 'تاریخ صدور',
        'type_insurance_policies' => 'نوع بیمه نامه',
        'installment_type' => 'نوع اقساط',
        'amount_of_each_installment' => 'مبلغ هرقسط',
        'priority' => 'اولویت',
        'category' => 'دسته بندی',
