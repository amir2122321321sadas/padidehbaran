                                    ...
                                    <div
                                        ...
                                        @php
                                            function formatMinutesToTime($minutes) {
                                                ...
                                                $mins = $minutes % 60;
                                                $secs = 0; // اگر ثانیه ندارید، صفر قرار دهید
                                                return sprintf('%02d:%02d:%02d', $hours, $mins, $secs);
                                            }
                                        @endphp
                                        <span class="font-bold text-sm text-foreground line-clamp-1">
                                            {{ formatMinutesToTime($course->total_time ?? 0) }}
                                        </span>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <div
                                        class="flex flex-col items-center justify-center text-center space-y-1">
                                                <span class="font-bold text-xs text-muted line-clamp-1">تعداد
                                                    فصل ها</span>
                                        <span
                                            class="font-bold text-sm text-foreground line-clamp-1">{{$course->chapters->count()}}</span>
                                    </div>
                                </div>
                                <div
                                    class="flex flex-col items-center justify-center gap-3 bg-secondary border border-border rounded-2xl cursor-default p-3">
                                                        ...
                                                        <div class="space-y-1">
                                                            ...
                                                            @foreach($chapter->files as $file)
                                                                ...
                                                                <div
                                                                    ...
                                                                    <span
                                                                        class="text-xs text-muted">{{$file->order}}</span>
                                                                    <div
                                                                        class="w-1 h-1 bg-muted-foreground rounded-full">
                                                                    </div>
                                                                    @php
                                                                    $courseChapterFile = $file;
                                                                    @endphp
                                                                    <a href="{{ route('course-detail-file', [$course , $courseChapterFile]) }}"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            <span class="text-xs">
                                                                                {{ gmdate('H:i:s', ($file->total_time ?? 0) * 60) }}
                                                                            </span>
                                                                            <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="bg-gradient-to-b from-secondary to-background rounded-2xl px-5 pb-5">
                    <div class="bg-background rounded-b-3xl space-y-2 p-5 mb-5">
                        <div class="flex items-center gap-3">
                            ...
                            <div class="font-black text-foreground">مشاهده دوره</div>
                        </div>
                    </div>
...
{{--                        </div>--}}
                    ...
                    <div class="flex gap-3 mt-3">
                        <button type="button" disabled
                            ...
                            <span class="font-semibold text-sm">دوره برای سطح شما فعال میباشد</span>
